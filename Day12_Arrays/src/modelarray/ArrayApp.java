...
public class ArrayApp {
    ...
    public static void main(String[] args) {
        ...
        int[] minTabel = {4, 6, 7, 2, 3};
        System.out.println(metode.sum(minTabel));

        double[] minTabelIgen = {4.5, 6.2, 7.1, 2.8, 3.9};
        System.out.println(metode.sum(minTabelIgen));

        int[] minTabelIgenIgen = {3, 0, 9, 5, 5};
        System.out.println(Arrays.toString(metode.makeSum(minTabel, minTabelIgenIgen)));

        int[] minTabelIgenIgenIgen = {4, 6, 8, 2, 4};
        System.out.println(metode.hasUneven(minTabel));
        System.out.println(metode.hasUneven(minTabelIgenIgenIgen));

        int[] minTabelIgenIgenIgenIgen = {3, 0, 9, 5, 5, 1, 2, 3, 4};
        System.out.println(Arrays.toString(metode.makeSum(minTabel, minTabelIgenIgenIgenIgen)));
    }
