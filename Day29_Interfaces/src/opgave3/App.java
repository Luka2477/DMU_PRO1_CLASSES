...
public class App {
    public static void main(String[] args) {
        ...
        AgeDiscount d3 = new AgeDiscount(28);
        ...
        Customer c3 = new Customer("Nicolai Knudsen", LocalDate.of(1993, 4, 20), d3);
        ...
        System.out.printf("%s samlet køb uden rabat: %f | med rabat: %f%n", c3.getName(), c3.totalBuy(), c3.totalBuyWithDiscount());
    }
}
